...
# MediaShield AI: Real-Time Deepfake Detection System

## Introduction
Deepfake technology, driven by recent advancements in artificial intelligence and deep learning, enables the creation of highly realistic yet manipulated images and videos. While such technology has beneficial applications, its misuse has become a serious concern, leading to the spread of misinformation, identity impersonation, and digital fraud.

To address this challenge, this project presents MediaShield AI: Real-Time Deepfake Detection System, a deep learning–based solution designed to identify fake images and videos efficiently. The system employs a convolutional neural network using transfer learning with MobileNetV2, enabling fast and accurate detection suitable for real-time applications.

In addition to classification, MediaShield AI integrates explainable artificial intelligence (XAI) through Grad-CAM visualization, which highlights the regions of media that influence the model’s decision. Implemented as a user-friendly desktop application, the system supports both image and video analysis, providing confidence scores and detection history. This project aims to contribute a practical, transparent, and scalable approach to digital media authenticity verification.

## Features
## Real-Time Image Deepfake Detection
The system allows users to upload images and instantly determines whether the image is real or fake using a deep learning–based classifier.

## Real-Time Video Deepfake Detection
Videos are analyzed by sampling frames at regular intervals, enabling efficient and fast detection without processing every frame.

## Lightweight and Efficient CNN Model
Uses MobileNetV2, which is optimized for low computational cost while maintaining reliable detection performance.

## Transfer Learning–Based Architecture
Leverages pretrained ImageNet weights and fine-tunes the network for deepfake-specific features, reducing training time and improving accuracy.

## Explainable AI using Grad-CAM
Generates heatmap visualizations that highlight manipulated regions in the image, improving transparency and trust in predictions.

## Confidence Score and Inference Time Display
Displays prediction confidence and processing time, helping users understand the reliability and efficiency of the system.

## Frame Sampling for Video Analysis
Processes selected frames instead of the entire video to reduce computation while maintaining detection effectiveness.

## User-Friendly Desktop GUI
Provides an intuitive graphical interface for easy interaction, suitable for non-technical users.

## Detection History and Result Tracking
Maintains a session-based history of analyzed media, including timestamps, results, and confidence values.

## Scalable and Extensible Design
The system architecture allows future integration of audio deepfake detection, web deployment, and mobile applications.
...
GPU: Optional (CPU-supported, GPU recommended for faster training)
...
Development Environment: VS Code / PyCharm / Anaconda
...
#### Output1 - REAL
<img width="1919" height="1016" alt="Screenshot 2025-12-12 192602" src="https://github.com/user-attachments/assets/037a2cdc-d3dc-4a46-bfc4-179ba7b8da63" />

#### Output2 - FAKE
<img width="1919" height="1020" alt="Screenshot 2025-12-12 193531" src="https://github.com/user-attachments/assets/c23c9c62-0f7e-4d7f-8ae1-a9c24ff4be7d" />

## Results and Impact
MediaShield AI effectively detects deepfake images and videos in real time using a lightweight deep learning model. The system provides reliable predictions with visual explainability through Grad-CAM, improving transparency and trust. It demonstrates practical impact in combating misinformation, digital fraud, and cybercrime, with strong potential for future scalability.
